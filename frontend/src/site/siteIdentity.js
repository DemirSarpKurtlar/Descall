/**
 * Shared public-facing operator / trust identity for marketing pages + prerender.
 * Keep copy factual — no fabricated reviews or fake legal entities.
 */
export const SITE_OPERATOR = {
  productName: "Descall",
  operatorName: "Demir Sarp Kurtlar",
  founderTitle: "Founder, owner, and CEO",
  founderTitleTr: "Kurucu, sahip ve CEO",
  country: "Türkiye",
  ...
  lastUpdatedLabel: "August 25, 2026",
  lastUpdatedLabelTr: "25 Ağustos 2026",
  status: "Beta",
  statusNote:
...
export const TRUST_FOOTER_LINKS = [
  ...
  { to: "/who-owns-descall", label: "Who owns Descall?" },
