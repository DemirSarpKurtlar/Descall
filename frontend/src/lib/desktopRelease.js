...
export const DESKTOP_RELEASE_FALLBACK = {
  ...
  version: "2.9.16",
  name: "2.9.16",
  htmlUrl: "https://github.com/DemirSarpKurtlar/Descall/releases/tag/v2.9.16",
  windowsDownloadUrl:
    "https://github.com/DemirSarpKurtlar/Descall/releases/download/v2.9.16/Descall-Setup-2.9.16.exe",
