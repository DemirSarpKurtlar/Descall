...
export const DESKTOP_RELEASE_FALLBACK = {
  ...
  version: "2.9.27",
  name: "2.9.27",
  htmlUrl: "https://github.com/DemirSarpKurtlar/Descall/releases/tag/v2.9.27",
  windowsDownloadUrl:
    "https://github.com/DemirSarpKurtlar/Descall/releases/download/v2.9.27/Descall-Setup-2.9.27.exe",
