...
export const DESKTOP_RELEASE_FALLBACK = {
  ...
  version: "2.9.13",
  name: "2.9.13",
  htmlUrl: "https://github.com/DemirSarpKurtlar/Descall/releases/tag/v2.9.13",
  windowsDownloadUrl:
    "https://github.com/DemirSarpKurtlar/Descall/releases/download/v2.9.13/Descall-Setup-2.9.13.exe",
