...
const FALLBACK_RELEASE = {
  ...
  htmlUrl: `https://github.com/${GITHUB_REPO}/releases/tag/v2.9.22`,
  windowsDownloadUrl: `https://github.com/${GITHUB_REPO}/releases/download/v2.9.22/Descall-Setup-2.9.22.exe`,
